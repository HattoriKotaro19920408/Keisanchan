...
public class MyPageAction extends ActionSupport implements SessionAware{
	...
	public String execute() throws SQLException{
		...
		myPageDtoList = myPageDao.getMyPageList(session.get("loginId"));
		...
		myPageList = myPageDAO.getMyPageList(company_name, roe, roa, uriage_keijo_ratio, uriage_sori_ratio, uriage_eigyo_ratio, total_kaiten_ratio, zaiko_kaiten_ratio, ryudo_ratio, zikoshi_ratio, kotei_ratio, fusai_ratio);
